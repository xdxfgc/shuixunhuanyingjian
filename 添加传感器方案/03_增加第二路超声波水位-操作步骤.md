...
> ✅ **注**：第二路超声波（**Trig D4 / Echo D13**）**已经在代码里实现了**（`distance_sensor2.cpp`）。
...
- 避开启动脚 D0 / D2 / D5 / D12 / D15（D5 要求上电为高电平，而 Trig 平时是低电平，**不要用**）
...
- `http://10.177.222.100/api/level2`
- `http://10.177.222.100/api/level2/height?value=85`（设置预定高度，单位毫米）
