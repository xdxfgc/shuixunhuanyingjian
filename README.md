...
| 文档 | 加什么 | 新增接口 |
|------|--------|----------|
| `00_引脚与接口总表.md` | **当前所有引脚 + 全部 API 接口** + 通用套路 | — |
| `增加第二路流量传感器-操作步骤.md` | 流量计 #2 | `/api/flow2`、`/api/volume2`、`/api/reset2` |
| `01_增加第三路温度传感器-操作步骤.md` | DS18B20 #3（已有 D27/D25 两路） | `/api/temperature3` |
...
| `06_增加第三路加热继电器-操作步骤.md` | 加热继电器 #3（D4） | `/api/heater3/on` 等 4 个 |
